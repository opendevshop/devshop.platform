...
options:
  ...
  stdout_file:
    description:
      - Pipe output to this file.
    type: str
  stdout_pipe:
    description:
      - The pipe character to use for stdout_file. Set to >> to append to the file.
    type: str
    default: ">"
  stderr_file:
    description:
      - Pipe stderr output to this file.
    type: str
  stderr_pipe:
    description:
      - The pipe character to use for stderr_file. Set to >> to append to the file.
    type: str
    default: ">"
...
def main():
    ...
    module = AnsibleModule(
        argument_spec=dict(
            ...
            stdout_file=dict(type='path'),
            stdout_pipe=dict(type='str', default=">"),
            stderr_file=dict(type='path'),
            stderr_pipe=dict(type='str', default=">"),
